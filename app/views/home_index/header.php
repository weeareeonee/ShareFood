...
<head>
    ...
    <!-- favicon
    ============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= BASEURL; ?>/assets/img/baz_new.png">
    <!-- Google Fonts
    ============================================ -->
            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item">
                            <a href="<?=BASEURL;?>/Mesjid"><i class="fa big-icon fa-building"></i> <span class="mini-dn">Restauran</span> <span class="indicator-right-menu mini-dn"></span></a>
                        </li>
