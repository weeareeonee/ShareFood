                    ...
                    <div class="col-xl-6 col-md-6 col-lg-6 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <img src="<?= BASEURL; ?>/assets_web/img/baz_new.png" alt="">
                                </a>
                            </div>
                            <p class="address_text">Badan Donasi ShareFood
                            </p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>+62 813 5891 6986 <br> +62 821 4590 4324</li>
                                <li><a href="#">sharefood@gmail.com</a></li>
                                <li>Jl.Dieng Atas, Malang, Jawa Timur, INDONESIA</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3  col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="<?=BASEURL;?>/Web/partner">Kerjasama Pihak Mitra</a></li>
