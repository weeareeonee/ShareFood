...
<!-- ================ contact section start ================= -->
    <section class="contact-section">
            <div class="container">  
            <p class="sample-text">
				<b>ShareFood</b> telah berhasil mengumpulkan total donasi sekitar Rp. dan telah disalurkan ke pihak-pihak yang membutuhkan. Berikut adalah rinciannya
			...
			<div class="section-top-border">
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							...
							<div class="percentage">Total Donasi Makanan</div>
							<div class="percentage">Total Donasi Uang</div>
						</div>
						<?php 
						$no=1;
						...
						<div class="table-row">
							...
							<div class="percentage"><?= $dt['total_beras'];?> /Pcs
                            </div>  
				...
				<p>
				Jika anda berminat untuk menyalurkan donasi anda, silahkan isi formulir dibawah ini.
				</p>
                <div class="row">
                    <div class="col-12">
